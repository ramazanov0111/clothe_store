            ...
            <div class="row">
                <form action="{{ route('user.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('firstname') }}" name="firstname" class="form-control" placeholder="Имя">
                    </div>
                    <div class="form-group">
                        <input type="text" value="{{ old('lastname') }}" name="lastname" class="form-control" placeholder="Фамилия">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('password_confirmation') }}" name="password_confirmation" class="form-control" placeholder="Пароль">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('phone') }}" name="phone" class="form-control" placeholder="Телефон">
                    </div>
                    <div class="form-group">
